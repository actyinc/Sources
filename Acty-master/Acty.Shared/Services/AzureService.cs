        ...
        public MobileServiceClient Client
        {
            get
            {
                if(_client == null)
                {
                    ...
                    ////_client = new MobileServiceClient(Keys.AzureDomain);
        ...
        public Task DeleteMembership(string id)
        {
            return new Task(() =>
            {
                ...
                try
                {
                    ...
                    var challenges = DataManager.Instance.Challenges.Values.Where(c => c.LeagueId == m.LeagueId).ToList();
