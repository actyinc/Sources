...
[assembly:Xamarin.Forms.Dependency(typeof(Acty.Android.MainActivity))]

namespace Acty.Android
{
    [Activity(Label = "Acty", MainLauncher = true, Icon = "@drawable/icon", Theme = "@style/GrayTheme", ScreenOrientation = ScreenOrientation.Portrait)]
