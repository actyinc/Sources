...
namespace DocumentDBServiceTest
{
    ...
    public class CampaignTests
    {
        ...
        public void TestCreateVideoCampaign()
        {
            ...
            Assert.IsTrue(_campaignsController.CreateCampaign(new MemoryStream(FormUpload.MultipartFormDataPost(postParameters))));
        }
        ...
        {
            IEnumerable<DBCampaign> feeds = _campaignsController.GetTopFeedsForUser(_user1.Email);
